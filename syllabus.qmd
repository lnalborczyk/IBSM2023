...
- Basic knowledge of `R` data manipulation. Elementary objects and calculations in `R`.

## Training content

This course is made up of ten two-hour sessions during which theoretical knowledge and practical work in `R` will be provided, in the `RStudio` environment.
