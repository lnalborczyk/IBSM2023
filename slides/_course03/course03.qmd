...
This modelling implies two constraints:
...
On average (without considering the predictors), it seems that chimpanzees are slightly more likely to pull the left lever than the right...
...
- $text{admit}_{i}$: The number of applications accepted (`admit`).
